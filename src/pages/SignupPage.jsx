...
const UTAH_HOUSE_DISTRICTS = Array.from({ length: 75 }, (_, i) => i + 1);
...
export default function SignupPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (!form.houseDistrict) {
      setError("Please select your Utah House District.");
      return;
    }
    ...
    try {
      ...
      await setDoc(doc(db, "volunteers", user.uid), {
        ...
        houseDistrict: Number(form.houseDistrict),
        role: "volunteer",
    ...
    <div className="min-h-screen bg-cream flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Become a Delegate</p>
        </div>
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Utah House District <span className="text-coral">*</span>
            </label>
            <select
              name="houseDistrict"
              required
              value={form.houseDistrict}
              onChange={handleChange}
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-navy/30 bg-white"
            >
              <option value="">Select your district…</option>
              {UTAH_HOUSE_DISTRICTS.map((d) => (
                <option key={d} value={d}>
                  HD {d}{d === 21 ? " — District 21 (Wiley)" : ""}
                </option>
              ))}
            </select>
          </div>
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <a href="/login" className="text-navy underline">Log in</a>
          </p>
        </form>
